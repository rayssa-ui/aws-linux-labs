-- Aurora MySQL Lab — SQL commands

-- 1. List available databases
SHOW DATABASES;

-- 2. Switch to the 'world' database (created via Initial database name at cluster creation)
USE world;
...
-- 5. Query: countries with GNP > 35000 and Population > 10,000,000
-- Expected: Australia and Thailand
